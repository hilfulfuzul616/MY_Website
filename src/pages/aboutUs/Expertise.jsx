      ...
      <div className="my-container grid gap-8 sm:gap-4 sm:grid-cols-2">
        ...
        <div className="pl-3">
          <div className="sm:w-max">
            <SectionTitle text={"our expertise"} number={""} />
          </div>
          ...
          <div className="space-y-3">
            ...
            Explore our vast knowledge and experience in a diverse range of domains, setting new standards of excellence{" "}
            </p>
          </div>
        </div>
        {/* right  */}
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-[40px,_1fr] gap-3 bg-pink-100/40 p-4 rounded-md">
            ...
            <div className="flex flex-col">
              ...
              We take pride in delivering your products or services on schedule, ensuring your plans stay on track
              </p>
            </div>
          </div>
          {/* item 2  */}
          <div className="grid grid-cols-[40px,_1fr] gap-3 bg-teal-100/40 p-4 rounded-md">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-zinc-700">
              Our commitment to excellence means you can expect nothing but the best. We never compromise on quality
              </p>
            </div>
          </div>
          {/* item 3  */}
          <div className="grid grid-cols-[40px,_1fr] gap-3 bg-orange-100/40 p-4 rounded-md">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-zinc-700">
              Count on us to provide comprehensive support and assistance, guiding you every step of the way to achieve your goals
              </p>
            </div>
          </div>
        </div>
